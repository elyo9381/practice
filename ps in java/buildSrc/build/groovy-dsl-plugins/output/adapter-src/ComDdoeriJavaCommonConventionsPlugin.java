...
/**
 * Precompiled com.ddoeri.java-common-conventions script plugin.
 **/
public class ComDdoeriJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComDdoeriJavaCommonConventions").asSubclass(BasicScript.class);
