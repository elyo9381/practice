...
- [x] BOJ 14503 로봇청소기 (시뮬레이션) ← 1번째
- [x] BOJ 3190 뱀 (시뮬레이션) ← 2번째, Deque 사용
- [x] BOJ 14888 연산자 끼워넣기 (백트래킹) ← 3번째
- [x] BOJ 14502 연구소 (BFS+백트래킹) ← 4번째
- [x] BOJ 15683 감시 (구현) ← 5번째, 가장 어려움
...
### Day 5: 미니 모의고사 #1
- [x] 2시간 타이머, 프로그래머스 L2 3문제 (컬러링북, 타겟넘버, 게임맵최단거리)
- [x] 끝난 후 즉시 오답 분석 + T+1 등록
